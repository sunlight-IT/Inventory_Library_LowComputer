...
void    Events_ServoMotor(void);      // 读写器事�?
void    Event_Init_ServoMotor(void);  // 初�?�化事件
...
// 串口
void    UartWrite_ServoMotor(uint8_t *pData, uint16_t Size);  // 串口发送函�?
void    UartReceiveIT_ServoMotor(void);                       // 读写器串口中�?接收
void    UartGetData_ServoMotor(void);                         // 处理接收到的数据到新的数组，并重新接�?
...
void    UartDriver_ServoMotor(void);                          // 串口主循�?驱动函数
...
#define MonitorRegister_1_Data 0x0012  // 状态监控缓存器1的�?�取起�?�位
#define MonitorRegister_1_Set  0x0022  // 状态监控缓存器1设置�?
#define MonitorRegister_2_Set  0x0024  // 状态监控缓存器2设置�?
#define MonitorRegister_3_Set  0x0026  // 状态监控缓存器3设置�?
#define MonitorRegister_4_Set  0x0028  // 状态监控缓存器4设置�?
#define MonitorRegister_5_Set  0x002A  // 状态监控缓存器5设置�?
#define PulseMonitor_0022H     0x0000  // 脉冲回授（状态监控�?�置�?
#define TorqueMonitor_0024H    0x000B  // �?矩回授（状态监控�?�置�?
#define SpeedMonitor_0026H     0x0007  // 速度回授（状态监控�?�置�?
#define Monitor_0028H          0x0003  // 保留设置（状态监控�?�置�?
#define Monitor_002AH          0x0000  // 保留设置（状态监控�?�置�?

#define GearRatioRegister_Numerator   0x0158  // 电子齿轮比分子（N1�?
#define GearRatioRegister_Denominator 0x015A  // 电子齿轮比分母（M�?
// 写入正确的电子齿�?比分子分母的设置，分�?160，分�?94，�?�应的皮�?94mm/圈，计算得出94000脉冲/圈，1000脉冲/mm,�?160000脉冲/�?
#define GearRatio_Numerator_0158H   0x000000A0  // 电子齿轮比分子（N1�?160
#define GearRatio_Denominator_015AH 0x0000005E  // 电子齿轮比分母（M�?94

#define AuxrFuncRegister_P2_30 0x023C  // 0:关闭所有下述功�?;1：强制软�? Servo On�?5：�?�定�?防�?�连�?写入EEPROM,若使用通�??控制时必需将�?�参数�?�定�?
#define EEPROM_Disable_P2_30   0x0005

#define PulseReset_Register_P2_50 0x0264  // 脉冲清除模式，需要�?�置�?0x11;
#define PulseReset_Data_P2_50     0x0011  // 脉冲清除模式，需要�?�置�?0x11;
...
#define PT_Szmode_Register_P1_01 0x0102  // 控制模式及控制命令输入源设定,写入4，�?�置速度模式，写�?0，�?�置位置模式
#define PTmode_Data_P1_01        0x0000  // 写入0，�?�置位置模式
#define Szmode_Data_P1_01        0x0004  // 写入4，�?�置速度模式

#define DI2_PulseClear_Register_P2_11   0x0216  // DI2设置0x0004-脉冲清除,0x0104	//脉冲恢�?��?�数
#define DI2_PulseClear_Start_Data_P2_11 0x0004  // 0x0004-脉冲清除
#define DI2_PulseClear_End_Data_P2_11   0x0104  // 0x0104-脉冲恢�?��?�数
